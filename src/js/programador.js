...
//DIALOG NO STOCK DISCO / DISCO NO DISPONIBLES ++++++++++DISCOS+++++++++++++++++++++
   ...
   //BOTON PARA CERRAR TODOS LOS DIALOG DE STOCK
    ...
    $('.closenostock').on('click', function(){
    	$('#nostockalabes, #noavailablealabes, #nostockdisco, #noavailabledisco, #sistockalabes, #sistockdisco, #siavailabledisco, #siavailablealabes, #noavailablenostockdisco, #noavailablenostockalabes').dialog('close');
    });  
